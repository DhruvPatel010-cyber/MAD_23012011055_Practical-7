package com.example.mad_23012011055_practical_7
...
import com.example.mad_23012011055_practical_7.db.DatabaseHelper
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                val data = HttpRequest().makeServiceCall(
                    "https://api.json-generator.com/templates/fXurFOiiq23j/data?access_token=24a8eshfmxvv9odx0b9f4ef761texjca0hn7ohuu",
                    null
                )
